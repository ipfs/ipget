...
import (
	...
	smux "github.com/noffle/ipget/Godeps/_workspace/src/github.com/jbenet/go-stream-muxer"
	mp "github.com/noffle/ipget/Godeps/_workspace/src/github.com/whyrusleeping/go-multiplex" // Conn is a connection to a remote peer.
)
